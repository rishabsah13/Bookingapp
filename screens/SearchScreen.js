...
const SearchScreen = () => {
    ...
    return (
        <SafeAreaView>
            <View style={{
                padding: 10, marginTop: 40, marginLeft: 15, flexDirection: "row", alignItems: "center",

                justifyContent: "space-between", borderColor: "yellow", borderWidth: 4, borderRadius: 10
            }}>
                <TextInput placeholder='Enter your destination' value={input} onChangeText={(text) => setinput(text)} />
