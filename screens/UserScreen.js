    ...
    return (
        <>
            <View style={{ padding: 20 }}>
                ...
                <View style={{ flexDirection: "column", gap: 10, marginTop: 10 }}>
                    <Text>Phone no.</Text>
                    <TextInput value={phoneNo} onChangeText={(text) => setPhoneNo(text)}
                        style={{ padding: 10, borderColor: "gray", borderWidth: 1 }} />
                </View>

            </View>
            <Pressable style={{ backgroundColor: "white", justifyContent: "space-between", marginTop: "auto", marginBottom: 40, flexDirection: "row", alignItems: "center", padding: 10 }}>
                ...
                <View>
                    ...
                    <Text>You Saved {route.params.oldPrice - route.params.newPrice}</Text>
                </View>
                <Pressable
                    onPress={finalStep}
                    style={{ backgroundColor: "#007FFF", padding: 10, borderRadius: 5 }}>
                    <Text style={{ color: "white", textAlign: "center", fontSize: 15 }}>Final Step</Text>
                </Pressable>
            </Pressable>
        </>
    )
