            ...
            <BottomModal
                ...
                footer={<ModalFooter>
                    <Pressable
                        ...
                        style={{ paddingRight: 10, marginLeft: "auto", marginRight: "auto", marginVertical: 10, marginBottom: 20 }}>
                        <Text>Apply</Text>
                    </Pressable>
                </ModalFooter>
                }
                ...
                <ModalContent style={{ width: "100%", height: 280 }}>
                    <View style={{ flexDirection: "row" }}>
                        <View style={{ marginVertical: 10, flex: 2, height: 280, borderRightWidth: 1, borderRightColor: "tranparent" }}>
                            <Text>Sort</Text>
                        ...
                        <View style={{ flex: 3, margin: 12 }}>
                            {filters.map((item, index) => (
                                <Pressable
                                    ...
                                    {selectedFilter.includes(item.filter) ? (<FontAwesome name="circle" size={18} color="green" />) : (<Entypo name="circle" size={18} color="black" />)}

                                    <Text style={{ fontSize: 16, fontWeight: "600", marginLeft: 6, color: "black" }}>{item.filter}</Text>
                                </Pressable>
                            ))}
                        </View>
                    </View>
